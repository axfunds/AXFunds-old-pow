...
static const int64 DUST_SOFT_LIMIT = 10000; // 00010000 0.0001 
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0001000 0.00001  mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 84000000 * COIN; //2.718 281 828.4590 4523 536028747135266249775// * COIN;
...
public:
    ...
    // {
        ...
        // return block;
    // }
    CBlockHeader GetBlockHeader() const; //for merge mining
